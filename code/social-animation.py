...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/mizwally/Desktop/SCANS-social_animation_fNIRS/code/social-animation.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('../stimuli/stimuli_order_all.csv'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    for thisTrial in trials:
        ...
        print(trials.trialList[2])
        if trials.trialList[2][i] == 'nonsocial' :
            condition = 1
        else :
            condition = 2
        trigger = (i*10) + condition
